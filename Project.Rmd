...
movements_within_restaurant <- filter_movements_within_restaurant(sf_movements_utm2, buffer_utm)

# Function to assign restaurant IDs after filtering
assign_restaurant_ids <- function(filtered_movements, restaurants) {

  return(joined)
}

# Assign restaurant IDs to filtered movements
movements_with_restaurant_ids <- assign_restaurant_ids(movements_within_restaurant, sf_restaurants_utm2)


colnames(movements_within_restaurant)
head(movements_within_restaurant, 100)
head(sf_movements_utm2)
